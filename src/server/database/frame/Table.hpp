...
public:
    ...
    constexpr uint32_t ROWS_PER_PAGE = PAGE_SIZE / Row::ROW_SIZE;
    ...
    char* row_data(uint32_t row_num){
...
template<class Row>
Table<Row>::Table(std::string_view filename)
: num_rows(0) {
